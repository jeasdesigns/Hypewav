...
- Variants:
  - Selling Fast: Background #67E8F9 at 90% opacity
...
- Profile Avatar:
  - Outer: 44×44px, gradient (#A78BFA → #67E8F9), radius 9999px
  - Inner: 40×40px, #13121E, radius 9999px
  - Text: 14px / Medium (500) / #F1F0FB
