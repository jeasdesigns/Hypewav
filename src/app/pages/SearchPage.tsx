        ...
        {loading && (
          <div className="flex items-center justify-center h-[calc(100vh-200px)]">
            <div className="text-center gap-3 flex flex-col items-center">
              ...
              <p className="text-[#9CA3AF] text-sm">Loading shows…</p>
            </div>
          </div>
        )}
              ...
              {searchVenues.map(venue => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-semibold text-[#F1F0FB] truncate">{venue.name}</h4>
                    <p className="text-sm text-[#9CA3AF] truncate">{venue.address}</p>
                  </div>
