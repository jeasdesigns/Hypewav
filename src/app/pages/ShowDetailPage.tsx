...
export function ShowDetailPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-hype-bg-primary flex items-center justify-center">
  ...
  return (
    <AppLayout showBottomNav={true}>
      {/* Hero */}
      <div className="relative h-[420px] bg-gradient-to-b from-hype-bg-secondary via-[#13121E] to-hype-bg-primary">
